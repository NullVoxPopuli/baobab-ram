...
type NestedSunburstData =
  | { name: string; value?: never; children: NestedSunburstData[] }
  | { name: string; value: number };

export type SunburstData = { name: string; value?: never; children: NestedSunburstData[] };

export class Info extends Resource {
  get json(): SunburstData {
    // return
    // {
    //   name: 'root',
    //   children: [],
  ...
  @tracked totalMemory: unknown;
  @tracked freeMemory: unknown;
